...
EMCC_CFLAGS := $(OPTIMISATIONS) $(INCLUDE_PATHS) -I$(EMCC_RAYLIB_INCLUDE_PATH) $(DEFINIES) -s FETCH=1 -s TOTAL_STACK=16777216 -s USE_GLFW=3 -s ASYNCIFY -s INITIAL_MEMORY=134217728 -s ALLOW_MEMORY_GROWTH=1
